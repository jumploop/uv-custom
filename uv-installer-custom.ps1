...
The installer for uv 0.7.19

.DESCRIPTION

This script detects what platform you're on and fetches an appropriate archive from
https://github.com/astral-sh/uv/releases/download/0.7.19
...
param (
    ...
    [string]$ArtifactDownloadUrl = 'https://github.com/astral-sh/uv/releases/download/0.7.19',
...
if ($env:INSTALLER_DOWNLOAD_URL) {
  ...
  $ArtifactDownloadUrl = "$installer_base_url/astral-sh/uv/releases/download/0.7.19"
}
